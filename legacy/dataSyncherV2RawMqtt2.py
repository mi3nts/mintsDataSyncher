...
if __name__ == "__main__":
    ...
    sysStr = 'rsync -avzrtum -e "ssh -p 2222" ' +  includeStatement+ "--include='*/' --exclude='*' mints@mintsdata.utdallas.edu:/mfs/io/groups/lary/mintsData/rawMqtt/" + " " + "/AirPool/DISK/share-drive/Data/mintsData/rawMqtt/"
    print(sysStr)
    # os.system(sysStr)
